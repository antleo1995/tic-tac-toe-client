...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  if (store.user === undefined || store.user === null) {
	    ...
	    // catch/fail scenario
	    .then(ui.changePasswordSuccess).catch(ui.changePasswordFailure);
	  }
	};
	...
	var callSignUpModal = function callSignUpModal() {
	  $('#signUpModal').modal();
	};
	var callSignInModal = function callSignInModal() {
	  $('#signInModal').modal();
	};
	module.exports = {
	  addHandlers: addHandlers,
	  callSignUpModal: callSignUpModal,
	  callSignInModal: callSignInModal
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkVictory = __webpack_require__(12);
	var gameapi = __webpack_require__(13);
	...
	var createGame = function createGame() {
	  ...
	  .then(gameui.createGameSuccess).catch(gameui.gameCreateFailure);
	  getGamesOver();
	};
	// retrieves the number of games completed on server
	// display portion happens in onGetGameSuccess
	var getGamesOver = function getGamesOver() {
	  // runs api call passing data
	  gameapi.getGamesOver()
	  // catch/fail for getGamesOver
	  .then(gameui.onGetGameSuccess).catch(gameui.onGetGameFailure);
	};
	var fillBoardNbsp = function fillBoardNbsp() {
	...
	var resetGameOnSignout = function resetGameOnSignout() {
	  // fills div tags in table back with non-breaking space
	  fillBoardNbsp();
	  // sets board back to all empty
	  board = ['', '', '', '', '', '', '', '', ''];
	...
	var updateGame = function updateGame(gamedata) {
	  gameapi.updateGame(gamedata).then(gameui.updateGameSuccess).catch(gameui.updateGameSuccess);
	};
	// primary function of board
	// added to each td on page load
	var putMarker = function putMarker() {
	...
	module.exports = {
	  ...
	  playerIs: playerIs,
	  id: id,
	  fillBoardNbsp: fillBoardNbsp,
	  resetGameOnSignout: resetGameOnSignout
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var checkVictory = function checkVictory(player, board, numOfMoves, gameOver) {
	...
	var checkServerWins = function checkServerWins(board, player) {
	  if (
	  // First row check
	  board[0] === player && board[1] === player && board[2] === player ||
	  // Second row check
	...
	var displayWins = function displayWins() {
	  var resultX = 0;
	  var resultO = 0;
	  for (var i = 0; i < store.gameData.length; i++) {
	  ...
	  var cat = store.gameData.length - (resultO + resultX);
	...
	module.exports = {
	  ...
	  checkServerWins: checkServerWins,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesOver = function getGamesOver(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameCreateFailure = function gameCreateFailure(error) {
	  return error;
	};
	var updateGameSuccess = function updateGameSuccess(data) {
	  store.gameData = data.games;
	};
	var updateGameFailure = function updateGameFailure(data) {
	  store.gameData = data.games;
	};
	var onGetGameSuccess = function onGetGameSuccess(data) {
	  store.gameData = data.games;
	  game.displayWins();
	};
	var onGetGameFailure = function onGetGameFailure(error) {
	  return error;
	};

	module.exports = {
	  createGameSuccess: createGameSuccess,
	  gameCreateFailure: gameCreateFailure,
	  onGetGameSuccess: onGetGameSuccess,
	  onGetGameFailure: onGetGameFailure,
